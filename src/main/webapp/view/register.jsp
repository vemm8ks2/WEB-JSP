  ...
  <div class="register-wrapper">
    ...
    <form action="register.do" method="post" class="register-form">
      <label for="register_id" class="primary-input">
        <input id="register_id" name="register_id" placeholder="&nbsp;" />
        <span>아이디</span>
      </label>
      <label for="register_pwd" class="primary-input">
        <input id="register_pwd" name="register_pwd" type="password" placeholder="&nbsp;" />
        <span>비밀번호</span>
      </label>
      ...
      <label for="register_name" class="primary-input">
        <input id="register_name" name="register_name" placeholder="&nbsp;" />
        <span>이름</span>
      </label>
      <label for="register_phone" class="primary-input">
        <input id="register_phone" name="register_phone" placeholder="&nbsp;" />
        <span>휴대폰</span>
      </label>
      <label for="register_addr" class="primary-input">
        <input id="register_addr" name="register_addr" placeholder="&nbsp;" />
        <span>주소</span>
      </label>
      <button>가입하기</button>
    </form>
