...
public class CreateProductAction implements Action {
  ...
  public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
   ...
   // 파일 업로드를 위한 객체 생성.
      ...
      String product_createdAt = multi.getParameter("product_createdAt").trim();
      String product_updatedAt = multi.getParameter("product_updatedAt").trim();
      ...
      dto.setProductCreatedAt(product_createdAt);
      dto.setProductUpdatedAt(product_updatedAt);
